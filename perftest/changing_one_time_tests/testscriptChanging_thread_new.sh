...
echo "uniform_changing_sideways_fenwick_11select_1change, uniform_changing_sideways_fenwick_11thread_1thread" > results_${2}.csv
...
for ((i=1; i<=$1; i++)); do
    ...
    echo "$result0,$result1" >> results_${2}.csv
...
echo " " >> results_${2}.csv
echo "$average0,$average1" >> results_${2}.csv
